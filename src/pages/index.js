...
const IndexPage = () => (
  <Layout>
    ...
    description="We all have a desire to be heard, to be understood, and soothed...Experienced therapist, Barbara Gelfand, Highland Park, NJ provides therapy and counseling."
    />
    <Pagetitle
